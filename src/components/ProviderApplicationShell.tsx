      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="grid items-start gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:gap-12">
          ...
          <aside className="public-card public-card-accent isolate !border-[#1A0A5E] !bg-[#1A0A5E] text-white shadow-[0_30px_80px_rgba(26,10,94,0.28)] lg:sticky lg:top-8">
            ...
            <div className="public-card-body relative p-8 sm:p-10">
              <p className="mb-2 text-xs font-bold uppercase tracking-[0.2em] text-[#F5C200]">
                {eyebrow}
              </p>
              <h1 className="max-w-xl text-3xl font-extrabold leading-tight tracking-[-0.03em] sm:text-4xl">
                {title}
              </h1>
              <p className="mt-4 max-w-lg text-sm leading-6 text-white/75">{description}</p>
              ...
              <div className="mt-8 flex gap-3 rounded-2xl border border-white/15 bg-white/[0.06] p-4">
